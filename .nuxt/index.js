...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Artenupcia - Invitaciones de Boda pesonalizadas, con mucho amor.","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Artenupcia"}],"script":[{"innerHTML":"\n        !(function (f, b, e, v, n, t, s) {\n          if (f.fbq) return\n          n = f.fbq = function() {\n            n.callMethod ? n.callMethod.apply(n, arguments) : n.queue.push(arguments)\n          }\n          if (!f._fbq) f._fbq = n\n          n.push = n\n          n.loaded = !0\n          n.version = '2.0'\n          n.queue = []\n          t = b.createElement(e)\n          t.async = !0\n          t.src = v\n          s = b.getElementsByTagName(e)[0]\n          s.parentNode.insertBefore(t, s)\n        })(window, document, 'script', 'https:\u002F\u002Fconnect.facebook.net\u002Fen_US\u002Ffbevents.js')\n        fbq('init', '838245813591792')\n        fbq('track', 'PageView')\n        ","type":"text\u002Fjavascript","charset":"utf-8"}],"__dangerouslyDisableSanitizers":["script"],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[]},
  ...
  if (typeof nuxt_plugin_axios_46febb82 === 'function') {
    await nuxt_plugin_axios_46febb82(app.context, inject)
  }
